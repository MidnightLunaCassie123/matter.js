...
function setup() {
  ...
  //whenever we create a engine a world gets created already with it
   ...
   var ball_options = {
    restitution: 0.95,
    //restitution is the bounciness to an object, the higher number u give, the more bouncy it with be and vias versa.
    frictionAir:0.01
    //friction due to the airs property.
  }
...
//we are creating our object i.e ground from Bodies
  ...
  box2=Bodies.rectangle(160,10,20,20,ball_options);
